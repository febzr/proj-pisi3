...
class pipelines():
    ...
    def create(self):
        ...
        def normalization(dados):
            minmax = utility.MinMax(dados)
            datas = minmax.normalization(['BMI','WeightInKilograms','HeightInMeters','GeneralHealth','PhysicalHealthDays','MentalHealthDays','SleepHours'])
            return datas
